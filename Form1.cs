...
namespace ParkingApp
{
    public partial class Form1 : Form
    {
        ...
        private void Login()
        {
            if (string.IsNullOrEmpty(userTextBox.Text) && string.IsNullOrEmpty(textBox1.Text))
            {

                label5.Text = "Missing Username and Password";
            }
            ...
            else if (textBox1.Text != password)
            {
                ...
                label3.Text = "Invalid Password"; //pag buhat lang og isa ka label kuya nya i butang sa ubos sa log in
            }
            else
            {
